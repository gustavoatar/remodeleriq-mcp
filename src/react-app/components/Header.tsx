import { X, User, LogOut, Settings, Crown, ChevronDown, BarChart3, Newspaper, BookOpen, Target, Radar, FileText, Palette, Wrench, Calculator } from 'lucide-react';
                ...
                >
                  <div className="bg-white rounded-xl shadow-lg border border-gray-200 py-2">
                    ...
                    <button
                      ...
                      className="flex items-center gap-3 px-4 py-3 transition-colors w-full text-left text-gray-700 hover:bg-gray-50 border-b border-gray-100"
                    >
                      <div className="w-10 h-10 rounded-lg flex items-center justify-center bg-gray-100">
                        <Wrench className="w-5 h-5 text-gray-600" />
                      </div>
                      <div>
                        <p className="font-medium text-sm">All Free Tools</p>
                        <p className="text-xs text-gray-500">Every homeowner tool in one place</p>
                      </div>
                    </button>

                    {/* Cost Estimator (static cost guides) */}
                    <a
                      href="/remodeling-cost-guides/"
                      onClick={() => setToolsMenuOpen(false)}
                      className="flex items-center gap-3 px-4 py-3 transition-colors w-full text-left text-gray-700 hover:bg-gray-50"
                    >
                      <div className="w-10 h-10 rounded-lg flex items-center justify-center bg-gray-100">
                        <Calculator className="w-5 h-5 text-gray-600" />
                      </div>
                      <div>
                        <p className="font-medium text-sm">Cost Estimator</p>
                        <p className="text-xs text-gray-500">2026 remodel costs by city</p>
                      </div>
                    </a>
